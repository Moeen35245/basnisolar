    ...
    <div className="text-white dark:text-inavy mt-10 px-6 md:px-0 max-w-[850px] flex flex-col  md:flex-row mx-auto gap-10">
      ...
      {active1 && (
        <motion.div
          ...
          className={`flex-1 mobile:flex-[40%]  pr-5 flex  flex-col justify-center items-center md:mr-0 md:my-auto`}
        >
      ...
      {active2 && (
        <motion.div
          ...
          className={`flex-1 transition-all duration-150 mobile:flex-[40%]  pr-5 flex  flex-col justify-center items-center md:mr-0 md:my-auto`}
        >
